...
export const ui = {
  en: {
    ...
    how: {
      title: "How we work",
      description: "Agents in every seat, gates at every door. Skills as roles, gates before shipping, every claim verified at the source.",
      annotation: "method",
      h1: "Agents in every seat, gates at every door.",
      lead: "Tuturama runs as a factory: coding agents organised the way an engineering team is organised, with people holding the judgement calls. The unit of work is small, the gates are strict, and the output is measured by what shipped and what got merged, not by what was typed.",
      aside: "Lean by design. The shape is what lets us sit inside a client's team without becoming a vendor, and ship products without a roadmap committee.",
      steps: [
        { name: "Skills as roles", body: "The factory is organised as a set of skills, each one a written role with its own checklist: reviewer, security officer, release engineer, accountant. An agent loads the role, does the work, and hands over to the next. People hold the judgement calls." },
    ...
    contact: {
      ...
      annotation: "contact",
      h1: "Write to us.",
      lead: "A person reads every message. Say what you are building, what cannot break, and when you need an answer.",
      asks: [
  ...
  et: {
    ...
    how: {
      ...
      description: "Agendid igal kohal, väravad igal uksel. Rollid oskustena, väravad enne väljalaset, iga väide kontrollitud allikast.",
      annotation: "meetod",
      h1: "Agendid igal kohal, väravad igal uksel.",
      lead: "Tuturama töötab tehasena: kodeerimisagendid on korraldatud nii, nagu on korraldatud insenerimeeskond, ja otsused jäävad inimestele. Tööühik on väike, väravad ranged ja tulemust mõõdetakse selle järgi, mis välja läks ja mis vastu võeti, mitte selle järgi, mis kirja pandi.",
      aside: "Kerge kavatsuslikult. Kuju on see, mis lubab meil istuda kliendi meeskonna sees ilma tarnijaks muutumata ja anda välja tooteid ilma teekaardi komiteeta.",
      steps: [
        { name: "Rollid oskustena", body: "Tehas on korraldatud oskuste kogumina, millest igaüks on kirjapandud roll oma kontrollnimekirjaga: ülevaataja, turvajuht, väljalaseinsener, raamatupidaja. Agent laeb rolli, teeb töö ära ja annab järgmisele üle. Otsused jäävad inimestele." },
    ...
    contact: {
      ...
      annotation: "kontakt",
      h1: "Kirjuta meile.",
      lead: "Iga kirja loeb inimene. Ütle, mida sa ehitad, mis ei tohi katki minna ja millal sa vastust vajad.",
      asks: [
