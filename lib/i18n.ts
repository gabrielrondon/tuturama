...
export const ui = {
  en: {
    ...
    nav: { products: "products", upstream: "upstream", agents: "agents", audit: "audit", how: "how we work", about: "about", contact: "contact", archive: "archive", github: "github", writing: "writing" },
    ...
    audit: {
      title: "Agent security audit",
      description: "Bring an agent, an MCP server or an agentic payment flow. In one to two weeks you get the threat model, the findings with file and line, the patch with tests, and a report your security team can act on.",
      annotation: "audit",
      h1: "Bring us an agent to break.",
      lead: "A fixed-scope security audit of one agent, MCP server or agentic payment flow. One to two weeks. You get the threat model, the findings with file and line, the patch with tests, and a report your security team can act on.",
      whyTitle: "Why now",
      why: "Agents now browse, pay and read private data on your behalf. The controls around them were written for humans clicking, not for a model that does whatever the last page told it. Most teams have shipped one already and nobody has audited it.",
      scopeTitle: "What we audit",
      scope: [
        { name: "URL and network gates", body: "Everything the agent can fetch or browse: link-local and cloud-credential ranges, parser bypasses, redirects, DNS rebinding. Forty test vectors with expected verdicts." },
        { name: "Payment and spend paths", body: "Who dictates amount, asset and recipient, where the pre-signature decision point is, and which primitive to ship first: audit log, asset pinning, allowlist, caps." },
        { name: "MCP and remote read surfaces", body: "Every operation exposed over MCP, checked against the privacy, tenancy and deletion filters the primary read path applies. We find the one that forgot." },
        { name: "Audit trail", body: "Whether an autonomous decision can be reviewed after the fact, and whether the log would survive tampering. We ship a signed, hash-chained format if there is none." },
      ],
      deliverTitle: "What you get",
      deliver: [
        { name: "Threat model", body: "The four axes for this system: the model as a non-boundary, the process surface, third-party trust, missing web-layer assumptions. Grounded in your code, with file and line." },
        { name: "Findings, ranked", body: "Each with the vector that proves it, the impact stated precisely (who can trigger it, from where, what they reach), and the smallest fix that matches your own conventions." },
        { name: "Patch with tests", body: "A pull request against your repo, with the vectors as regression tests. If a finding exposes live credentials in production, it goes through your security process instead of a PR." },
        { name: "Report", body: "One document your security team reads without us in the room. What was audited, what was found, what was fixed, what stays open and why." },
      ],
      ...
      proofTitle: "Method, in public",
      proof: "The audits are the same ones packaged as skills in agent-security, and the same ones that found a range gap in gstack's browser daemon, a missing decision point in an x402 payment server, and two gaps in our own payment guard, all fixed with tests.",
      proofLink: "See agent-security on GitHub",
      priceTitle: "Scope and price",
      price: "One system per engagement. Fixed price agreed before day 1, based on the size of the surface. A second system is a second engagement, not a change order.",
      formTitle: "Intake",
      formLead: "Five questions. They become the first page of the threat model.",
      form: {
        what: "What is the agent, MCP server or flow? One paragraph.",
        can: "What can it do on its own: browse, fetch, pay, read private data, call tools?",
        for: "Who does it act for, and who could feed it input it did not ask for?",
        stack: "Language, framework, where it runs (laptop, cloud, container).",
        when: "When do you need the report, and who reads it?",
        email: "Your email",
        submit: "send the intake",
        note: "The form opens your email client with the answers filled in. Nothing is stored on this site.",
      },
  ...
  et: {
    ...
    nav: { products: "tooted", upstream: "upstream", agents: "agendid", audit: "audit", how: "kuidas me töötame", about: "meist", contact: "kontakt", archive: "arhiiv", github: "github", writing: "kirjutised" },
    switchTo: "In English",
    ...
    audit: {
      title: "Agendi turvaaudit",
      description: "Too meile agent, MCP-server või agendimakse voog. Ühe kuni kahe nädalaga saad ohumudeli, leiud faili ja reaga, paranduse koos testidega ja aruande, millega su turvameeskond saab tegutseda.",
      annotation: "audit",
      h1: "Too meile agent, mida murda.",
      lead: "Kindla ulatusega turvaaudit ühele agendile, MCP-serverile või agendimakse voole. Üks kuni kaks nädalat. Sa saad ohumudeli, leiud faili ja reaga, paranduse koos testidega ja aruande, millega su turvameeskond saab tegutseda.",
      whyTitle: "Miks praegu",
      why: "Agendid sirvivad, maksavad ja loevad sinu nimel privaatseid andmeid. Nende ümber olevad kontrollid kirjutati inimestele, kes klõpsavad, mitte mudelile, mis teeb seda, mida viimane leht ütles. Enamik meeskondi on ühe juba välja lasknud ja keegi pole seda auditeerinud.",
      scopeTitle: "Mida me auditeerime",
      scope: [
        { name: "URL- ja võrguväravad", body: "Kõik, mida agent saab tõmmata või sirvida: link-local ja pilve tunnuste vahemikud, parseri möödaviigud, ümbersuunamised, DNS rebinding. Nelikümmend testvektorit oodatud otsustega." },
        { name: "Makse- ja kulutusteed", body: "Kes dikteerib summa, vara ja saaja, kus on allkirjaeelne otsustuspunkt ja milline primitiiv esimesena välja lasta: auditilogi, vara kinnitamine, lubamisnimekiri, piirid." },
        { name: "MCP ja kaug-lugemispinnad", body: "Iga MCP kaudu avatud operatsioon, kontrollituna privaatsuse, rentniku ja kustutamise filtrite vastu, mida peamine lugemistee rakendab. Leiame selle, mis unustas." },
        { name: "Auditijälg", body: "Kas autonoomset otsust saab tagantjärele üle vaadata ja kas logi elaks võltsimise üle. Kui logi pole, anname allkirjastatud, räsiga aheldatud vormingu." },
      ],
      deliverTitle: "Mida sa saad",
      deliver: [
        { name: "Ohumudel", body: "Neli telge selle süsteemi jaoks: mudel kui mitte-piir, protsessipind, kolmanda osapoole usaldus, puuduvad veebikihi eeldused. Sinu koodis, faili ja reaga." },
        { name: "Leiud, järjestatud", body: "Igaüks tõestava vektoriga, täpselt sõnastatud mõjuga (kes saab käivitada, kust, milleni jõuab) ja väikseima parandusega, mis järgib sinu enda tavasid." },
        { name: "Parandus koos testidega", body: "Pull request sinu repositooriumi vastu, vektorid regressioonitestidena. Kui leid paljastab tootmises elavaid tunnuseid, läheb see sinu turvaprotsessi kaudu, mitte PR-ina." },
        { name: "Aruanne", body: "Üks dokument, mida su turvameeskond loeb ilma meieta ruumis. Mida auditeeriti, mida leiti, mida parandati, mis jääb lahti ja miks." },
      ],
      howTitle: "Kuidas see käib",
      how: [
        "1. päev: ligipääs repositooriumile ja 45-minutiline kõne sellest, mida agent saab teha ja kelle nimel.",
        "2. kuni 7. päev: audit sinu repositooriumis, leiud jagatakse kinnitamise järjekorras. Lõpus üllatusi pole.",
        "8. kuni 10. päev: parandused, testid, aruanne. Lõpukõne sinu inseneridega, mitte slaidid.",
      ],
      proofTitle: "Meetod, avalikult",
      proof: "Auditid on samad, mis on pakendatud oskustena agent-security's, ja samad, mis leidsid vahemiku lünga gstacki brauseri-deemonis, puuduva otsustuspunkti x402 makseserveris ja kaks lünka meie enda maksekaitses, kõik parandatud testidega.",
      proofLink: "Vaata agent-security't GitHubis",
      priceTitle: "Ulatus ja hind",
      price: "Üks süsteem koostöö kohta. Kindel hind lepitakse kokku enne 1. päeva, pinna suuruse järgi. Teine süsteem on teine koostöö, mitte muudatus.",
      formTitle: "Sisend",
      formLead: "Viis küsimust. Neist saab ohumudeli esimene leht.",
      form: {
        what: "Mis on agent, MCP-server või voog? Üks lõik.",
        can: "Mida ta saab ise teha: sirvida, tõmmata, maksta, lugeda privaatseid andmeid, kutsuda tööriistu?",
        for: "Kelle nimel ta tegutseb ja kes võiks talle ette sööta sisendit, mida ta ei küsinud?",
        stack: "Keel, raamistik, kus see töötab (sülearvuti, pilv, konteiner).",
        when: "Millal sa aruannet vajad ja kes seda loeb?",
        email: "Sinu e-post",
        submit: "saada sisend",
        note: "Vorm avab sinu e-posti kliendi täidetud vastustega. Sellel saidil ei salvestata midagi.",
      },
      onePager: "Ühelehe PDF",
    },
    contact: {
      title: "Kontakt",
