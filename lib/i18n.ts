...
export const ui = {
  en: {
    ...
    home: {
      ...
      embeddedAside: "Currently advisor to the CISO Office of a European retail group, through Tuturama. Institutions we have worked inside over twenty years include Pearson, Société Générale, Walmart, Banco do Brasil and Kraken.",
      ...
      upstreamNote: "Every item links to the maintainers' review. Nothing here is self-published.",
    ...
    products: {
      ...
      lead: "Each product listens, reads or watches something on the user's behalf and turns it into a decision. They are the factory's own output: what we sell as method, we ship as product first.",
    ...
    upstream: {
      ...
      note: "Last verified against the source repositories on 6 September 2026. All work is authored by Gabriel Rondon, founder of Tuturama, under his own name.",
    },
    agents: {
    ...
    about: {
      ...
      paras: [
        ...
        "He writes code. He has twelve accepted commits in the Linux kernel, reviewed by maintainers at Intel and Huawei, and merged contributions to Stellar, FediMint, Rig and Foundry. He publishes open research at gabrielrondon.com.",
        "He holds an M.Sc. in Innovation and Technology Management from Université Paris 1 Panthéon-Sorbonne and is completing an MBA in Agribusiness at USP/ESALQ. He was born in Campo Grande, Brazil, has lived in Paris and Lisbon, and is moving home.",
      ],
      company: "Company",
  ...
  et: {
    ...
    home: {
      ...
      embeddedAside: "Praegu nõustame Tuturama kaudu ühe Euroopa jaekontserni CISO Office'it. Kahekümne aasta jooksul oleme töötanud muu hulgas Pearsonis, Société Générale'is, Walmartis, Banco do Brasilis ja Krakenis.",
      ...
      upstreamNote: "Iga rida viitab hooldajate ülevaatusele. Siin pole midagi ise avaldatut.",
    ...
    products: {
      ...
      lead: "Iga toode kuulab, loeb või jälgib midagi kasutaja nimel ja teeb sellest otsuse. Need on tehase enda toodang: mida me müüme meetodina, anname kõigepealt välja tootena.",
    ...
    upstream: {
      ...
      note: "Viimati kontrollitud lähterepositooriumide vastu 6. septembril 2026. Kogu töö on tehtud Tuturama asutaja Gabriel Rondoni enda nime all.",
    },
    agents: {
    ...
    about: {
      ...
      paras: [
        ...
        "Ta kirjutab koodi. Tal on Linuxi tuumas kaksteist vastuvõetud commit'i, mille vaatasid üle Inteli ja Huawei hooldajad, ning vastuvõetud panused Stellari, FediMinti, Rigi ja Foundrysse. Ta avaldab avatud uurimusi aadressil gabrielrondon.com.",
        "Tal on innovatsiooni- ja tehnoloogiajuhtimise magistrikraad Université Paris 1 Panthéon-Sorbonne'ist ja ta lõpetab agroäri MBA-d USP/ESALQ-is. Ta on sündinud Brasiilias Campo Grandes, elanud Pariisis ja Lissabonis ning kolib koju.",
      ],
      company: "Ettevõte",
